to setup
  ...
  ;; make yello atoms on right
  ask patches with [pxcor > 0 and pycor < 0]
    [ sprout 1 [ set color yellow ] ]
  ;; make blue atoms on right
  ask patches with [pxcor < 0 and pycor < 0]
...
to-report yellows
  report turtles with [color = yellow]
end

to-report reds
  report turtles with [color = red]
end
...
"pen-2" 1.0 0 -1184463 true "" "plot-atoms yellows"
"pen-3" 1.0 0 -2674135 true "" "plot-atoms reds"
